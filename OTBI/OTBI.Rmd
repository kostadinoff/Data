...
cost_per_INN = 
  ...
  scale_x_reordered()+
  theme(legend.position="none")+
  labs(title= "Разходи на НЗОК за таргетни онкологични медикаменти", subtitle = " log на разходите по по година",
       y=" ", x= " ") + theme(axis.title = element_text(family = "Courier")) +labs(alpha = 0.6)
cost_per_INN
```
